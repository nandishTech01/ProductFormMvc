			...
			<input type="hidden" value="${product.id}" name="id"  >
				...
				<div class="form-group">
					<label for="userName">Product Name:</label> <input type="text"
						...
						placeholder="Enter the product name here" name="name" value="${product.name}" required/>
				</div>
			 ...
			 <div class="form-group">
				...
				<div class="form-group">
					<label for="price">Product Price:</label> <input type="text"
						...
						placeholder="Enter the product price" name="price" value="${product.price}" required>
				</div>
